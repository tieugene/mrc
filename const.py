...
SCLD_FILEUNPUBLISH_ENDPOINT = CLOUD_APIv2 + "/file/unpublish";
...
SCLD_WEBLINKINFO_ENDPOINT = CLOUD_APIv2 + "/weblinks";
SCLD_WEBLINKRO_ENDPOINT = CLOUD_APIv2 + "/weblinks/readonly";
SCLD_WEBLINKRW_ENDPOINT = CLOUD_APIv2 + "/weblinks/writable";
